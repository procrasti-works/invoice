  ...
  return (
      ...
      <div className="grid min-h-[calc(100dvh-1rem)] gap-3 lg:grid-cols-[228px_minmax(0,1fr)] lg:min-h-[calc(100dvh-2rem)]">
        <aside className="flex min-w-0 flex-col bg-[#f7f7f5] px-2 py-2 lg:h-[calc(100dvh-2rem)]">
          <Link
            href="/dashboard"
            className="flex min-w-0 items-center gap-2 rounded-lg px-2 py-2 text-[#050505] transition-colors hover:bg-[#efefec]"
          >
            <span className="flex size-8 shrink-0 items-center justify-center text-black">
              <ReceiptText className="size-6 stroke-[2.3]" />
            </span>
            <span className="min-w-0 truncate text-[21px] font-semibold leading-none text-black">
              Invoice Ledger
            </span>
          </Link>
