...
export default function ScanPage() {
  ...
  return (
    <div className="db-page db-dashboard-page db-scan-page">
      ...
      {/* ── Receipt Tracker ── */}
      <section className="db-section" id="receipt-tracker">
        <div className="db-section-header">
          <div className="db-section-header-copy">
            <p className="db-panel-kicker">Receipt Tracker</p>
            <h2 className="db-section-title">Capture and track every expense receipt</h2>
            <p className="db-section-body">
