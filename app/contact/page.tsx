    ...
    <div className="il-page min-h-screen bg-white text-[var(--pv-ink)]">
      ...
      <main>
        ...
        <section className="border-y border-[var(--pv-line)] bg-[var(--pv-paper-bright)] px-5 py-10 sm:px-8">
          <div className="mx-auto grid max-w-[1180px] gap-4 md:grid-cols-4">
            {contactReasons.map((item) => (
              <div className="flex gap-3 rounded-[8px] border border-[var(--pv-line)] bg-white p-5" key={item}>
                <Check aria-hidden="true" className="mt-1 size-4 shrink-0 text-[var(--pv-green)]" />
        ...
        <section className="bg-white px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[0.72fr_1fr]">
            <div>
              ...
              <div className="mt-8 rounded-[8px] bg-[var(--pv-paper-warm)] p-6">
                <MapPin aria-hidden="true" className="size-6 text-[var(--pv-green)]" />
            ...
            <div className="grid gap-4">
              {people.map((person) => (
                <article className="rounded-[8px] border border-[var(--pv-line)] bg-white p-6" key={person.email}>
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-5 grid gap-2 text-sm font-bold text-[var(--ink-soft)]">
                        <a className="inline-flex items-center gap-2 break-all text-[var(--pv-green)]" href={`mailto:${person.email}`}>
                          <Mail aria-hidden="true" className="size-4 shrink-0" />
                          {person.email}
                        </a>
                        <a className="inline-flex items-center gap-2 text-[var(--ink-soft)]" href={person.href} rel="noreferrer" target="_blank">
        ...
        <section className="bg-[var(--pv-paper-warm)] px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[0.72fr_1fr]">
            <div>
              <p className="text-xs font-black uppercase text-[var(--pv-green)]">Questions</p>
              <h2 className="mt-5 text-4xl font-black leading-[1.02] sm:text-6xl">
        ...
        <section className="bg-[var(--pv-ink)] px-5 py-20 text-white sm:px-8 sm:py-28">
          <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[0.75fr_1fr] lg:items-center">
            <div>
              <MessageCircle aria-hidden="true" className="size-7 text-[var(--pv-mint)]" />
              <h2 className="mt-5 text-4xl font-black leading-[1.02] sm:text-6xl">
