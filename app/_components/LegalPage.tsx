    ...
    <div className="il-page min-h-screen bg-white text-[#0d141c]">
      ...
      <main>
        <section className="bg-white px-5 py-20 text-center sm:px-8 sm:py-28">
          ...
          <p className="mt-6 text-sm font-black uppercase text-[#687076]">
        ...
        <section className="border-y border-[#e4e8e0] bg-[#f8fbfa] px-5 py-10 sm:px-8">
          <div className="mx-auto grid max-w-[1180px] gap-4 md:grid-cols-3">
            {summary.map((item) => (
              <div
                className="rounded-[8px] border border-[#e4e8e0] bg-white p-5"
                key={item}
              >
                <p className="text-sm font-black leading-6 text-[#0d141c]">
                  {item}
                </p>
              </div>
            ))}
        ...
        <section className="bg-white px-5 py-16 sm:px-8 sm:py-24">
          <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[0.28fr_1fr] lg:items-start">
            <aside className="lg:sticky lg:top-28">
              ...
              <div className="mt-5 grid gap-3 rounded-[8px] bg-[#f5f7f2] p-5 text-sm font-bold text-[#4e5961]">
            ...
            <article className="grid gap-8">
              {sections.map((section, index) => (
                <section
                  className="rounded-[8px] border border-[#e4e8e0] bg-white p-6 sm:p-8"
                ...
                >
                  ...
                  <div className="mt-5 grid gap-4 text-base leading-8 text-[#4e5961]">
